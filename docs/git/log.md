...
## Cherry-picking a section of the log :material-new-box:{title="Feature added on the 10th March 2023"}
...
## Filtering the log with pattern matching :material-new-box:{title="Feature added on the 10th March 2023"}
